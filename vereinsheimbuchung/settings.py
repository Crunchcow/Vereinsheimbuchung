...
WSGI_APPLICATION = 'vereinsheimbuchung.wsgi.application'
...
# E-Mail (Konsole als Standard; im Produktion SMTP setzen)
...
# Interner API-Key für Webhook-Sync von ClubAuth
